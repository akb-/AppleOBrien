...
//EDIT THESE LINES
//Title of the blog
var TITLE = "Health News";
//RSS url
var RSS = "http://feedproxy.google.com/obrienpharmacy";
//Stores entries
var entries = [];
var selectedEntry = "";
...
$("#contentPage").live("pageshow", function(prepage) {
	...
	contentHTML += '<p/><a href="'+entries[selectedEntry].link + '" data-role="button">Read Entry on Site</a>';
