...
a.errormsg:d.responseDetails;h(c).html('<div class="rssError"><p>'+b+"</p></div>")}})})};var l=function(g,a,e){var j=a.feed;if(!j)return!1;var c=[],f="",d="odd";if(e.media)var m=p(a.xmlString).getElementsByTagName("item");e.header&&(f+='<div class="rssHeader"><a href="#" onClick="window.plugins.childBrowser.openExternal('+j.link+');" title="'+j.description+'">'+j.title+"</a></div>");f+='<div class="rssBody"><ul>';for(a=0;a<j.entries.length;a++){c[a]=[];var b=j.entries[a],k,i="";switch(e.sort){case "title":i=b.title;break;case "date":i=b.publishedDate}c[a].sort=
